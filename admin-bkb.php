                ...
                <table class="table table-bordered text-center mb-0">
                   ...
                   if($res->num_rows>0)
                   {
                       ...
                       <tr>
                           ...
                           <input class="p-2 border" type="hidden" name="qtyupdateid" value='. $row['crackers_id'] .'>
                           </td>
                           <td><input class="btn btn-primary text-center" type="Submit" name="qtyupdatebtn" value="Update"></td>
                           </form>
                       </tr>
                       '; 
                   }
               }
               if(isset($_POST["qtyupdatebtn"]))
               {
                    $item2=array(
                        'qtyupdateid'=> $_POST['qtyupdateid'],
