                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="admin.php" id="1" class="nav-item nav-link" onClick="reply_click(this.id)">Admin</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <div class="container pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-12 text-left">
                <div class="mb-4">
                    <h4 class="font-weight-semi-bold mb-4">Admin Login</h4>
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>Admin user name</label>
                            <input class="search-box col-md-6" name="ad_username" type="text">
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Admin E-mail</label>
                            <input class="search-box col-md-6" name="ad_email" type="text">
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Admin Password</label>
                            <input class="search-box col-md-6" name="ad_password" type="password">
                        </div> 
                    </div>
                </div>
            ...
            <div class="col-lg-12 mb-5 text-left">
                <button class="btn btn-primary" type="submit" name="ad-login">Login</button>
                <!-- <button class="btn btn-primary" type="submit" name="ad-logout">logout</button> -->
            </div>
