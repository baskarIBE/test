    ...
    <div class="container pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-12 text-left">
                <div class="mb-4">
                    <h4 class="font-weight-semi-bold mb-4">User Login</h4>
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>E-mail</label>
                            <input class="search-box col-md-6" name="email" type="text" placeholder="example@email.com">
                        </div>
                        <div class="col-md-12 form-group">
                            <label>Password</label>
                            <input class="search-box col-md-6" name="password" type="password" placeholder="">
                        </div> 
                    </div>
                </div>
