...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <?php include ('error.php') ?>
            <div class="col-lg-12">
                <div class="mb-4">
                    <h4 class="font-weight-semi-bold mb-4">User Registion</h4>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>First Name</label>
                            <input class="search-box" type="text" placeholder="John" name="firstname" value="<?php echo $firstname; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Last Name</label>
                            <input class="search-box" type="text" placeholder="Doe" name="lastname" value="<?php echo $lastname; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="search-box" type="text" placeholder="example@email.com" name="email" value="<?php echo $email; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="search-box" type="text" placeholder="+123 456 789" name="mobileno" value="<?php echo $mobileno; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 1</label>
                            <input class="search-box" type="text" placeholder="123 Street" name="address1" value="<?php echo $address1; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 2</label>
                            <input class="search-box" type="text" placeholder="123 Street" name="address2" value="<?php echo $address2; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Country</label>
                            <select class="custom-select" name="country" value="<?php echo $country; ?>">
                        ...
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <input class="search-box" type="text" placeholder="New York" name="city" value="<?php echo $city; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>State</label>
                            <input class="search-box" type="text" placeholder="New York" name="state" value="<?php echo $state; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>ZIP Code</label>
                            <input class="search-box" type="text" placeholder="123" name="zipcode" value="<?php echo $zipcode; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Password</label>
                            <input class="search-box" type="text" placeholder="123" name="password1" value="<?php echo $password1; ?>">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Conform Password</label>
                            <input class="search-box" type="text" placeholder="123" name="password2" value="<?php echo $password2; ?>">
                        </div>
                    </div>
                </div>
            </div>
